...
export class Ark__factory extends ContractFactory {
  ...
  deploy(_oldceikfm: string, overrides?: Overrides): Promise<Ark> {
    return super.deploy(_oldceikfm, overrides || {}) as Promise<Ark>;
  }
  getDeployTransaction(
    _oldceikfm: string,
    overrides?: Overrides
  ): TransactionRequest {
    return super.getDeployTransaction(_oldceikfm, overrides || {});
  }
