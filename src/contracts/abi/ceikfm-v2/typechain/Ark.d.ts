...
interface ArkInterface extends ethers.utils.Interface {
  functions: {
    ...
    "newceikfm()": FunctionFragment;
    "usersCount()": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "owner()": FunctionFragment;
    "isOwner()": FunctionFragment;
    "setNewceikfm(address)": FunctionFragment;
    "oldceikfm()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "newceikfm", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "setNewceikfm", values: [string]): string;
  encodeFunctionData(functionFragment: "oldceikfm", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "newceikfm", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "setNewceikfm", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "oldceikfm", data: BytesLike): Result;
...
export class Ark extends Contract {
  ...
  functions: {
    ...
    newceikfm(overrides?: CallOverrides): Promise<[string]>;
    ...
    "setNewceikfm(address)"(
      _newceikfm: string,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    oldceikfm(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    setNewceikfm(_newceikfm: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    newceikfm(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    setNewceikfm(_newceikfm: string, overrides?: Overrides): Promise<BigNumber>;
    ...
    oldceikfm(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    newceikfm(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    oldceikfm(overrides?: CallOverrides): Promise<PopulatedTransaction>;
