    ...
    constructor() {
        ...
        Layout.current.content.append(this.container = el(".classic-view",
            el("section",
                ...
                el("p.warning", "절대 본인의 세이크 클래식을 본인의 지갑에 전송하지 마세요. 세이크 클래식을 모두 잃어버릴 수 있습니다!"),
                el(".card",
                    el("h5", "세이크 클래식 가격"),
                    el("h6", (this.priceDisplay = el("span.price", "...")), " KLAY\n"),
                ),
                el("h3", "클레이로 세이크 클래식 사기"),
                el("p", "세이크 클래식을 살때도 떡크노믹스 때문에 10%를 적게 받습니다."),
                el(".form",
                ...
                el("h3", "세이크 클래식 클레이로 팔기"),
                el("p", "세이크 클래식을 펄때도 떡크노믹스 때문에 10%를 적게 받습니다."),
                el(".form",
